...
#Aller chercher le repertoire de travail
...
#LES NOMS DE CHACUNE DES COLONNES DOIVENT ETRE IDENTIQUES DANS CHACUNE DES TABLES POUR CHAQUE EQUIPE AFIN D'UTILISER LA FCT. RBIND
...
#Uniformiser le noms des colonnes pour l'ensemble des bases de donnees de chaque equipe = cours
