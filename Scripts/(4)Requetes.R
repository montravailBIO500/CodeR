...
# DETERMINER LE NOMBRE DE COLLABORATEURS PAR ETUDIANT DU COURS BIO500 (Figure 2/Histogramme)
requete_histogramme <- "
...
# REQUETE POUR AVOIR TOUS LES ETUDIANTS FAISANT PARTIE DU COURS BIO500 (Figure 1/Reseau)
requete_bio500 <- "
...
# DETERMINER LES COLLABORATIONS ENTRE "ETUDIANT1" DE BIO500 ET "ETUDIANT2" DE BIO500 (Figure 1/Reseau)
requete_reseau <- "
  SELECT etudiant1, count(etudiant2) AS nb_collaborateurs, etudiant2 FROM (
  SELECT DISTINCT etudiant1, etudiant2
  FROM BIO_5002
...
# DENOMBRER LE NOMBRE DE FOIS QUE DEUX COLLABORATEURS COLLABORENT (Figure3/Shannon)
requete_shannon <- "
